# urso_conhecimento_Func

Este workflow foi desenvolvido para automatizar processos relacionados a **urso_conhecimento_Func**. O fluxo manipula bancos de dados vetoriais/em memória para recuperar conhecimentos ou gerenciar sessões e contexto de memória (RAG ou Memory). É acionado automaticamente a partir de integrações externas.
...
- If, Code, Embeddingsopenai, Redis, Googlesheets, Splitinbatches, Set, Googledocs, Documentdefaultdataloader, Vectorstoreredis, Switch, Textsplitterrecursivecharactertextsplitter
