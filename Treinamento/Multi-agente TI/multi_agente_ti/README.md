...
Este workflow foi desenvolvido para automatizar processos relacionados a **multi-agente TI**. O fluxo utiliza agentes de Inteligência Artificial para processamento inteligente, tornando-o capaz de analisar dados, responder perguntas e tomar decisões dinâmicas. É acionado automaticamente a partir de integrações externas.
...
- If, Executeworkflow, Set, Textclassifier, Lmchatopenai, Noop, Gmail
