...
Este workflow foi desenvolvido para automatizar processos relacionados a **conteúdo_instagram**. O fluxo utiliza agentes de Inteligência Artificial para processamento inteligente, tornando-o capaz de analisar dados, responder perguntas e tomar decisões dinâmicas.
...
- Openai, Supabase, Httprequest, Splitout, Splitinbatches, Lmchatopenai, Set, Agent, Outputparserstructured, Toolthink, Wait, Memorybufferwindow
