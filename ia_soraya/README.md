...
Este workflow foi desenvolvido para automatizar processos relacionados a **IA Soraya**. O fluxo utiliza agentes de Inteligência Artificial para processamento inteligente, tornando-o capaz de analisar dados, responder perguntas e tomar decisões dinâmicas.
...
- Openai, Code, Switch, Extractfromfile, Lmchatopenai, Agent, Telegram, Memorybufferwindow
