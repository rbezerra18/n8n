# urso_conhecimento_plano_c

Este workflow foi desenvolvido para automatizar processos relacionados a **urso_conhecimento_plano_c**. O fluxo manipula bancos de dados vetoriais/em memória para recuperar conhecimentos ou gerenciar sessões e contexto de memória (RAG ou Memory). É acionado automaticamente a partir de integrações externas.
