...
Este workflow foi desenvolvido para automatizar processos relacionados a **urso_conhecimento**. O fluxo manipula bancos de dados vetoriais/em memória para recuperar conhecimentos ou gerenciar sessões e contexto de memória (RAG ou Memory). É acionado automaticamente a partir de integrações externas.
...
### 📥 Gatilhos (Triggers)
- Googledrive, Schedule

### ⚙️ Ações e Processamento
- If, Code, Embeddingsopenai, Redis, Stickynote, Googledrive, Googlesheets, Set, Limit, Googledocs, Documentdefaultdataloader, Vectorstoreredis, Switch, Textsplitterrecursivecharactertextsplitter, Merge
