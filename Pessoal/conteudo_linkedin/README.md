...
Este workflow foi desenvolvido para automatizar processos relacionados a **conteudo_linkedin**. O fluxo utiliza agentes de Inteligência Artificial para processamento inteligente, tornando-o capaz de analisar dados, responder perguntas e tomar decisões dinâmicas.
...
- Lmchatgooglegemini, Slack, Httprequest, Googlesheets, Agent
