...
Este workflow foi desenvolvido para automatizar processos relacionados a **My workflow**. O fluxo manipula bancos de dados vetoriais/em memória para recuperar conhecimentos ou gerenciar sessões e contexto de memória (RAG ou Memory).
