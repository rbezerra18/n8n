# urso_conhecimento_pine

Este workflow foi desenvolvido para automatizar processos relacionados a **urso_conhecimento_pine**. O fluxo manipula bancos de dados vetoriais/em memória para recuperar conhecimentos ou gerenciar sessões e contexto de memória (RAG ou Memory). É acionado automaticamente a partir de integrações externas.
...
- Embeddingsopenai, Googledrive, Vectorstorepinecone, Documentdefaultdataloader, Textsplitterrecursivecharactertextsplitter
